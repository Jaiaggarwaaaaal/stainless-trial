...
from ._exceptions import EniacError, APIStatusError
...
__all__ = ["Timeout", "Transport", "ProxiesTypes", "RequestOptions", "Eniac", "AsyncEniac", "Client", "AsyncClient"]


class Eniac(SyncAPIClient):
    pet: pet.PetResource
    store: store.StoreResource
    user: user.UserResource
    with_raw_response: EniacWithRawResponse
    with_streaming_response: EniacWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous Eniac client instance.
        ...
        if base_url is None:
            base_url = os.environ.get("ENIAC_BASE_URL")
        if base_url is None:
        ...
        self.with_raw_response = EniacWithRawResponse(self)
        self.with_streaming_response = EniacWithStreamedResponse(self)
...
class AsyncEniac(AsyncAPIClient):
    pet: pet.AsyncPetResource
    store: store.AsyncStoreResource
    user: user.AsyncUserResource
    with_raw_response: AsyncEniacWithRawResponse
    with_streaming_response: AsyncEniacWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncEniac client instance.
        ...
        self.with_raw_response = AsyncEniacWithRawResponse(self)
        self.with_streaming_response = AsyncEniacWithStreamedResponse(self)
...
class EniacWithRawResponse:
    def __init__(self, client: Eniac) -> None:
...
class AsyncEniacWithRawResponse:
    def __init__(self, client: AsyncEniac) -> None:
...
class EniacWithStreamedResponse:
    def __init__(self, client: Eniac) -> None:
...
class AsyncEniacWithStreamedResponse:
    def __init__(self, client: AsyncEniac) -> None:
