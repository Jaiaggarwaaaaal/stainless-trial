...
pip install git+ssh://git@github.com/Jaiaggarwaaaaal/stainless-trial.git
```
...
```sh
# install from the production repo
pip install 'eniac[aiohttp] @ git+ssh://git@github.com/Jaiaggarwaaaaal/stainless-trial.git'
```
...
These methods return an [`APIResponse`](https://github.com/Jaiaggarwaaaaal/stainless-trial/tree/main/src/eniac/_response.py) object.

The async client returns an [`AsyncAPIResponse`](https://github.com/Jaiaggarwaaaaal/stainless-trial/tree/main/src/eniac/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
...
We are keen for your feedback; please open an [issue](https://www.github.com/Jaiaggarwaaaaal/stainless-trial/issues) with questions, bugs, or suggestions.
